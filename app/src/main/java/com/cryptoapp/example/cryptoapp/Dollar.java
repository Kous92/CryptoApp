...
public class Dollar extends AppCompatActivity {
    ...
    public void btc(View view) {
        Intent intent = new Intent(this, BTC.class);
    ...
    private class ServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            double usd = (double)intent.getSerializableExtra("dollar");
            if(usd > 0.0 ){dollar = usd;}
    ...
    private void updateAfterSubscribe(final @NonNull Currency[] currencies) {
        ...
        for (Currency c :currencies) {
            c.setLastPrice( c.getLastPrice() * dollar );
        }
